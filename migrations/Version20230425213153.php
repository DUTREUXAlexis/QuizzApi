 ...
 */
final class Version20230425213153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, theme_id INT NOT NULL, texte VARCHAR(255) NOT NULL, reponses LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', reponse_juste VARCHAR(255) NOT NULL, INDEX IDX_B6F7494E59027487 (theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
